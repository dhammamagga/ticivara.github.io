...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__8761__auto__ = (function markdown$lists$close_lists_$_iter__14377(s__14378){
return (new cljs.core.LazySeq(null,(function (){
var s__14378__$1 = s__14378;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__14378__$1);
if(temp__4657__auto__){
var s__14378__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14378__$2)){
var c__8759__auto__ = cljs.core.chunk_first(s__14378__$2);
var size__8760__auto__ = cljs.core.count(c__8759__auto__);
var b__14380 = cljs.core.chunk_buffer(size__8760__auto__);
if((function (){var i__14379 = (0);
while(true){
if((i__14379 < size__8760__auto__)){
var vec__14381 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8759__auto__,i__14379);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14381,(0),null);
cljs.core.chunk_append(b__14380,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(list_type)),">"].join(''));

var G__14387 = (i__14379 + (1));
i__14379 = G__14387;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14380),markdown$lists$close_lists_$_iter__14377(cljs.core.chunk_rest(s__14378__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14380),null);
}
} else {
var vec__14384 = cljs.core.first(s__14378__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14384,(0),null);
return cljs.core.cons(["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(list_type)),">"].join(''),markdown$lists$close_lists_$_iter__14377(cljs.core.rest(s__14378__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__14388_SHARP_){
return (cljs.core.second(p1__14388_SHARP_) > num_indents);
...
var vec__14389 = cljs.core.last(cljs.core.cst$kw$lists.cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14389,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14389,(1),null);
...
var content = clojure.string.trim((function (){var G__14392 = text;
var G__14393 = (num_indents + (1));
return (markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2(G__14392,G__14393) : markdown.common._STAR_substring_STAR_.call(null,G__14392,G__14393));
})());
...
var vec__14394 = cljs.core.last(cljs.core.cst$kw$lists.cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14394,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14394,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__14397){
var map__14398 = p__14397;
var map__14398__$1 = ((((!((map__14398 == null)))?((((map__14398.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14398.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14398):map__14398);
var state = map__14398__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14398__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14398__$1,cljs.core.cst$kw$codeblock);
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14398__$1,cljs.core.cst$kw$last_DASH_line_DASH_empty_QMARK_);
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14398__$1,cljs.core.cst$kw$eof);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14398__$1,cljs.core.cst$kw$lists);
