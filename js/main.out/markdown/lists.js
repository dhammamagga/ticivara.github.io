...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__8761__auto__ = (function markdown$lists$close_lists_$_iter__15483(s__15484){
return (new cljs.core.LazySeq(null,(function (){
var s__15484__$1 = s__15484;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__15484__$1);
if(temp__4657__auto__){
var s__15484__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__15484__$2)){
var c__8759__auto__ = cljs.core.chunk_first(s__15484__$2);
var size__8760__auto__ = cljs.core.count(c__8759__auto__);
var b__15486 = cljs.core.chunk_buffer(size__8760__auto__);
if((function (){var i__15485 = (0);
while(true){
if((i__15485 < size__8760__auto__)){
var vec__15487 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8759__auto__,i__15485);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15487,(0),null);
cljs.core.chunk_append(b__15486,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(list_type)),">"].join(''));

var G__15493 = (i__15485 + (1));
i__15485 = G__15493;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15486),markdown$lists$close_lists_$_iter__15483(cljs.core.chunk_rest(s__15484__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15486),null);
}
} else {
var vec__15490 = cljs.core.first(s__15484__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15490,(0),null);
return cljs.core.cons(["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(list_type)),">"].join(''),markdown$lists$close_lists_$_iter__15483(cljs.core.rest(s__15484__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__15494_SHARP_){
return (cljs.core.second(p1__15494_SHARP_) > num_indents);
...
var vec__15495 = cljs.core.last(cljs.core.cst$kw$lists.cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15495,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15495,(1),null);
...
var content = clojure.string.trim((function (){var G__15498 = text;
var G__15499 = (num_indents + (1));
return (markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2(G__15498,G__15499) : markdown.common._STAR_substring_STAR_.call(null,G__15498,G__15499));
})());
...
var vec__15500 = cljs.core.last(cljs.core.cst$kw$lists.cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15500,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15500,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__15503){
...
var state = map__15504__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15504__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15504__$1,cljs.core.cst$kw$codeblock);
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15504__$1,cljs.core.cst$kw$last_DASH_line_DASH_empty_QMARK_);
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15504__$1,cljs.core.cst$kw$eof);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15504__$1,cljs.core.cst$kw$lists);
