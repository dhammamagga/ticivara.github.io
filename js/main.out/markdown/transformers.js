...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__14402){
var map__14403 = p__14402;
var map__14403__$1 = ((((!((map__14403 == null)))?((((map__14403.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14403.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14403):map__14403);
var state = map__14403__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14403__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14403__$1,cljs.core.cst$kw$codeblock);
...
var G__14405 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__14406 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__14405;
remaining = G__14406;
continue;
} else {
var G__14407 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__14408 = cljs.core.rest(remaining);
buf = G__14407;
remaining = G__14408;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__14409){
var map__14410 = p__14409;
var map__14410__$1 = ((((!((map__14410 == null)))?((((map__14410.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14410.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14410):map__14410);
var state = map__14410__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14410__$1,cljs.core.cst$kw$buf);
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14410__$1,cljs.core.cst$kw$next_DASH_line);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14410__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14410__$1,cljs.core.cst$kw$codeblock);
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14410__$1,cljs.core.cst$kw$heading_DASH_anchors);
...
markdown.transformers.br = (function markdown$transformers$br(text,p__14412){
var map__14413 = p__14412;
var map__14413__$1 = ((((!((map__14413 == null)))?((((map__14413.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14413.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14413):map__14413);
var state = map__14413__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14413__$1,cljs.core.cst$kw$code);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14413__$1,cljs.core.cst$kw$lists);
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__14416){
...
var state = map__14417__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14417__$1,cljs.core.cst$kw$code);
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14417__$1,cljs.core.cst$kw$frozen_DASH_strings);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,((function (currently_frozen,map__14417,map__14417__$1,state,code,frozen_strings){
return (function (p1__14415_SHARP_){
var vec__14419 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__14415_SHARP_,(1),(cljs.core.count(p1__14415_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14419,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14419,(1),null);
...
});})(currently_frozen,map__14417,map__14417__$1,state,code,frozen_strings))
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__14422_SHARP_){
var encoded = (cljs.core.truth_(cljs.core.cst$kw$clojurescript.cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__14422_SHARP_,(1),(cljs.core.count(p1__14422_SHARP_) - (1))):cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (c){
if((cljs.core.rand.cljs$core$IFn$_invoke$arity$0() > 0.5)){
var G__14423 = "&#x%02x;";
var G__14424 = (c | (0));
return (markdown.transformers._STAR_formatter_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.transformers._STAR_formatter_STAR_.cljs$core$IFn$_invoke$arity$2(G__14423,G__14424) : markdown.transformers._STAR_formatter_STAR_.call(null,G__14423,G__14424));
} else {
return c;
}
}),cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__14422_SHARP_,(1),(cljs.core.count(p1__14422_SHARP_) - (1))))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__14425){
...
var state = map__14426__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14426__$1,cljs.core.cst$kw$inline_DASH_heading);
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__14428){
var map__14429 = p__14428;
var map__14429__$1 = ((((!((map__14429 == null)))?((((map__14429.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14429.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14429):map__14429);
var state = map__14429__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$eof);
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$paragraph);
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$blockquote);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$heading);
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$hr);
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$temp);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$lists);
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$inline_DASH_heading);
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$last_DASH_line_DASH_empty_QMARK_);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14429__$1,cljs.core.cst$kw$code);
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__14431){
...
var state = map__14432__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14432__$1,cljs.core.cst$kw$next_DASH_line);
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14432__$1,cljs.core.cst$kw$paragraph);
if(cljs.core.truth_((function (){var and__7941__auto__ = paragraph;
if(cljs.core.truth_(and__7941__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__14434 = next_line;
if((G__14434 == null)){
return null;
} else {
return clojure.string.trim(G__14434);
}
})()));
} else {
return and__7941__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__14435){
var map__14436 = p__14435;
var map__14436__$1 = ((((!((map__14436 == null)))?((((map__14436.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14436.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14436):map__14436);
var state = map__14436__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14436__$1,cljs.core.cst$kw$eof);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14436__$1,cljs.core.cst$kw$lists);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14436__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14436__$1,cljs.core.cst$kw$codeblock);
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__14438){
...
var state = map__14439__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14439__$1,cljs.core.cst$kw$codeblock);
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14439__$1,cljs.core.cst$kw$codeblock_DASH_end);
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14439__$1,cljs.core.cst$kw$indented_DASH_code);
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14439__$1,cljs.core.cst$kw$next_DASH_line);
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__14441 = next_line;
if((G__14441 == null)){
return null;
} else {
return clojure.string.trim(G__14441);
}
})()));
...
var vec__14442 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_," "),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14442,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14442,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["<pre><code",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.not_empty(lang))?[" ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(formatter)?(function (){var G__14445 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(lang);
return (formatter.cljs$core$IFn$_invoke$arity$1 ? formatter.cljs$core$IFn$_invoke$arity$1(G__14445) : formatter.call(null,G__14445));
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__14446){
var map__14447 = p__14446;
var map__14447__$1 = ((((!((map__14447 == null)))?((((map__14447.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14447.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14447):map__14447);
var state = map__14447__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14447__$1,cljs.core.cst$kw$eof);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14447__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14447__$1,cljs.core.cst$kw$codeblock);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14447__$1,cljs.core.cst$kw$lists);
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__7953__auto__ = code;
if(cljs.core.truth_(or__7953__auto__)){
return or__7953__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__14449){
var map__14450 = p__14449;
var map__14450__$1 = ((((!((map__14450 == null)))?((((map__14450.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14450.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14450):map__14450);
var state = map__14450__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14450__$1,cljs.core.cst$kw$blockquote_DASH_start);
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14450__$1,cljs.core.cst$kw$blockquote_DASH_end);
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14450__$1,cljs.core.cst$kw$blockquote_DASH_paragraph);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14450__$1,cljs.core.cst$kw$lists);
...
var G__14454 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__14455){
var vec__14456 = p__14455;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14456,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14456,(1),null);
...
var fexpr__14453 = ((function (G__14454){
return (function (p1__14452_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__14452_SHARP_),"</ol>"].join('');
});})(G__14454))
;
return fexpr__14453(G__14454);
}
});
/**
...
var vec__14459 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14459,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14459,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14459,(2),null);
var vec__14462 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14462,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14462,(1),null);
...
var vec__14465 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14465,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14465,(1),null);
...
var G__14468 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__14469 = cljs.core.rest(remain);
var G__14470 = key;
acc = G__14468;
remain = G__14469;
prev_key = G__14470;
