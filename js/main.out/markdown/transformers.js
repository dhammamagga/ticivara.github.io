...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__15508){
var map__15509 = p__15508;
var map__15509__$1 = ((((!((map__15509 == null)))?((((map__15509.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15509.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15509):map__15509);
var state = map__15509__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15509__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15509__$1,cljs.core.cst$kw$codeblock);
...
var G__15511 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__15512 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__15511;
remaining = G__15512;
continue;
} else {
var G__15513 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__15514 = cljs.core.rest(remaining);
buf = G__15513;
remaining = G__15514;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__15515){
...
var state = map__15516__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,cljs.core.cst$kw$buf);
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,cljs.core.cst$kw$next_DASH_line);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,cljs.core.cst$kw$codeblock);
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15516__$1,cljs.core.cst$kw$heading_DASH_anchors);
...
markdown.transformers.br = (function markdown$transformers$br(text,p__15518){
...
var state = map__15519__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15519__$1,cljs.core.cst$kw$code);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15519__$1,cljs.core.cst$kw$lists);
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__15522){
...
var state = map__15523__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15523__$1,cljs.core.cst$kw$code);
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15523__$1,cljs.core.cst$kw$frozen_DASH_strings);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,((function (currently_frozen,map__15523,map__15523__$1,state,code,frozen_strings){
return (function (p1__15521_SHARP_){
var vec__15525 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__15521_SHARP_,(1),(cljs.core.count(p1__15521_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15525,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15525,(1),null);
...
});})(currently_frozen,map__15523,map__15523__$1,state,code,frozen_strings))
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__15528_SHARP_){
var encoded = (cljs.core.truth_(cljs.core.cst$kw$clojurescript.cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__15528_SHARP_,(1),(cljs.core.count(p1__15528_SHARP_) - (1))):cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (c){
if((cljs.core.rand.cljs$core$IFn$_invoke$arity$0() > 0.5)){
var G__15529 = "&#x%02x;";
var G__15530 = (c | (0));
return (markdown.transformers._STAR_formatter_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.transformers._STAR_formatter_STAR_.cljs$core$IFn$_invoke$arity$2(G__15529,G__15530) : markdown.transformers._STAR_formatter_STAR_.call(null,G__15529,G__15530));
} else {
return c;
}
}),cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__15528_SHARP_,(1),(cljs.core.count(p1__15528_SHARP_) - (1))))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__15531){
var map__15532 = p__15531;
var map__15532__$1 = ((((!((map__15532 == null)))?((((map__15532.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15532.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15532):map__15532);
var state = map__15532__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15532__$1,cljs.core.cst$kw$inline_DASH_heading);
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__15534){
...
var state = map__15535__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$eof);
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$paragraph);
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$blockquote);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$heading);
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$hr);
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$temp);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$lists);
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$inline_DASH_heading);
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$last_DASH_line_DASH_empty_QMARK_);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15535__$1,cljs.core.cst$kw$code);
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__15537){
...
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15538__$1,cljs.core.cst$kw$next_DASH_line);
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15538__$1,cljs.core.cst$kw$paragraph);
if(cljs.core.truth_((function (){var and__7941__auto__ = paragraph;
if(cljs.core.truth_(and__7941__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__15540 = next_line;
if((G__15540 == null)){
return null;
} else {
return clojure.string.trim(G__15540);
}
})()));
} else {
return and__7941__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__15541){
var map__15542 = p__15541;
var map__15542__$1 = ((((!((map__15542 == null)))?((((map__15542.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15542.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15542):map__15542);
var state = map__15542__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15542__$1,cljs.core.cst$kw$eof);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15542__$1,cljs.core.cst$kw$lists);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15542__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15542__$1,cljs.core.cst$kw$codeblock);
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__15544){
...
var state = map__15545__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15545__$1,cljs.core.cst$kw$codeblock);
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15545__$1,cljs.core.cst$kw$codeblock_DASH_end);
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15545__$1,cljs.core.cst$kw$indented_DASH_code);
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15545__$1,cljs.core.cst$kw$next_DASH_line);
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__15547 = next_line;
if((G__15547 == null)){
return null;
} else {
return clojure.string.trim(G__15547);
}
})()));
...
var vec__15548 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_," "),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15548,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15548,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["<pre><code",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.not_empty(lang))?[" ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(formatter)?(function (){var G__15551 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(lang);
return (formatter.cljs$core$IFn$_invoke$arity$1 ? formatter.cljs$core$IFn$_invoke$arity$1(G__15551) : formatter.call(null,G__15551));
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__15552){
var map__15553 = p__15552;
var map__15553__$1 = ((((!((map__15553 == null)))?((((map__15553.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15553.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15553):map__15553);
var state = map__15553__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15553__$1,cljs.core.cst$kw$eof);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15553__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15553__$1,cljs.core.cst$kw$codeblock);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15553__$1,cljs.core.cst$kw$lists);
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__7953__auto__ = code;
if(cljs.core.truth_(or__7953__auto__)){
return or__7953__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__15555){
var map__15556 = p__15555;
var map__15556__$1 = ((((!((map__15556 == null)))?((((map__15556.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15556.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15556):map__15556);
var state = map__15556__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15556__$1,cljs.core.cst$kw$blockquote_DASH_start);
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15556__$1,cljs.core.cst$kw$blockquote_DASH_end);
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15556__$1,cljs.core.cst$kw$blockquote_DASH_paragraph);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15556__$1,cljs.core.cst$kw$lists);
...
var G__15560 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__15561){
var vec__15562 = p__15561;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15562,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15562,(1),null);
...
var fexpr__15559 = ((function (G__15560){
return (function (p1__15558_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__15558_SHARP_),"</ol>"].join('');
});})(G__15560))
;
return fexpr__15559(G__15560);
}
});
/**
...
var vec__15565 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15565,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15565,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15565,(2),null);
var vec__15568 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15568,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15568,(1),null);
...
var vec__15571 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15571,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15571,(1),null);
...
var G__15574 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__15575 = cljs.core.rest(remain);
var G__15576 = key;
acc = G__15574;
remain = G__15575;
prev_key = G__15576;
