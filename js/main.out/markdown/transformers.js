...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__14424){
var map__14425 = p__14424;
var map__14425__$1 = ((((!((map__14425 == null)))?((((map__14425.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14425.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14425):map__14425);
var state = map__14425__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14425__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14425__$1,cljs.core.cst$kw$codeblock);
...
var G__14427 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__14428 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__14427;
remaining = G__14428;
continue;
} else {
var G__14429 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__14430 = cljs.core.rest(remaining);
buf = G__14429;
remaining = G__14430;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__14431){
...
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14432__$1,cljs.core.cst$kw$buf);
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14432__$1,cljs.core.cst$kw$next_DASH_line);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14432__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14432__$1,cljs.core.cst$kw$codeblock);
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14432__$1,cljs.core.cst$kw$heading_DASH_anchors);
...
markdown.transformers.br = (function markdown$transformers$br(text,p__14434){
...
var state = map__14435__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14435__$1,cljs.core.cst$kw$code);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14435__$1,cljs.core.cst$kw$lists);
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__14438){
...
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14439__$1,cljs.core.cst$kw$code);
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14439__$1,cljs.core.cst$kw$frozen_DASH_strings);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,((function (currently_frozen,map__14439,map__14439__$1,state,code,frozen_strings){
return (function (p1__14437_SHARP_){
var vec__14441 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__14437_SHARP_,(1),(cljs.core.count(p1__14437_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14441,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14441,(1),null);
...
});})(currently_frozen,map__14439,map__14439__$1,state,code,frozen_strings))
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__14444_SHARP_){
var encoded = (cljs.core.truth_(cljs.core.cst$kw$clojurescript.cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__14444_SHARP_,(1),(cljs.core.count(p1__14444_SHARP_) - (1))):cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (c){
if((cljs.core.rand.cljs$core$IFn$_invoke$arity$0() > 0.5)){
var G__14445 = "&#x%02x;";
var G__14446 = (c | (0));
return (markdown.transformers._STAR_formatter_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.transformers._STAR_formatter_STAR_.cljs$core$IFn$_invoke$arity$2(G__14445,G__14446) : markdown.transformers._STAR_formatter_STAR_.call(null,G__14445,G__14446));
} else {
return c;
}
}),cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__14444_SHARP_,(1),(cljs.core.count(p1__14444_SHARP_) - (1))))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__14447){
var map__14448 = p__14447;
var map__14448__$1 = ((((!((map__14448 == null)))?((((map__14448.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14448.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14448):map__14448);
var state = map__14448__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14448__$1,cljs.core.cst$kw$inline_DASH_heading);
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__14450){
...
var state = map__14451__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$eof);
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$paragraph);
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$blockquote);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$heading);
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$hr);
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$temp);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$lists);
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$inline_DASH_heading);
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$last_DASH_line_DASH_empty_QMARK_);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14451__$1,cljs.core.cst$kw$code);
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__14453){
...
var state = map__14454__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14454__$1,cljs.core.cst$kw$next_DASH_line);
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14454__$1,cljs.core.cst$kw$paragraph);
if(cljs.core.truth_((function (){var and__7941__auto__ = paragraph;
if(cljs.core.truth_(and__7941__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__14456 = next_line;
if((G__14456 == null)){
return null;
} else {
return clojure.string.trim(G__14456);
}
})()));
} else {
return and__7941__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__14457){
...
var state = map__14458__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14458__$1,cljs.core.cst$kw$eof);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14458__$1,cljs.core.cst$kw$lists);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14458__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14458__$1,cljs.core.cst$kw$codeblock);
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__14460){
...
var state = map__14461__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14461__$1,cljs.core.cst$kw$codeblock);
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14461__$1,cljs.core.cst$kw$codeblock_DASH_end);
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14461__$1,cljs.core.cst$kw$indented_DASH_code);
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14461__$1,cljs.core.cst$kw$next_DASH_line);
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__14463 = next_line;
if((G__14463 == null)){
return null;
} else {
return clojure.string.trim(G__14463);
}
})()));
...
var vec__14464 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_," "),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14464,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14464,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["<pre><code",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.not_empty(lang))?[" ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(formatter)?(function (){var G__14467 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(lang);
return (formatter.cljs$core$IFn$_invoke$arity$1 ? formatter.cljs$core$IFn$_invoke$arity$1(G__14467) : formatter.call(null,G__14467));
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__14468){
...
var state = map__14469__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14469__$1,cljs.core.cst$kw$eof);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14469__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14469__$1,cljs.core.cst$kw$codeblock);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14469__$1,cljs.core.cst$kw$lists);
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__7953__auto__ = code;
if(cljs.core.truth_(or__7953__auto__)){
return or__7953__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__14471){
...
var state = map__14472__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14472__$1,cljs.core.cst$kw$blockquote_DASH_start);
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14472__$1,cljs.core.cst$kw$blockquote_DASH_end);
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14472__$1,cljs.core.cst$kw$blockquote_DASH_paragraph);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14472__$1,cljs.core.cst$kw$lists);
...
var G__14476 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__14477){
var vec__14478 = p__14477;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14478,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14478,(1),null);
...
var fexpr__14475 = ((function (G__14476){
return (function (p1__14474_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__14474_SHARP_),"</ol>"].join('');
});})(G__14476))
;
return fexpr__14475(G__14476);
}
});
/**
...
var vec__14481 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14481,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14481,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14481,(2),null);
var vec__14484 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14484,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14484,(1),null);
...
var vec__14487 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14487,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14487,(1),null);
...
var G__14490 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__14491 = cljs.core.rest(remain);
var G__14492 = key;
acc = G__14490;
remain = G__14491;
prev_key = G__14492;
