...
var len__9122__auto___14243 = arguments.length;
var i__9123__auto___14244 = (0);
while(true){
if((i__9123__auto___14244 < len__9122__auto___14243)){
args__9129__auto__.push((arguments[i__9123__auto___14244]));

var G__14245 = (i__9123__auto___14244 + (1));
i__9123__auto___14244 = G__14245;
continue;
} else {
}
break;
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq14242){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14242));
});
...
var G__14248 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__4655__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$kw$frozen_DASH_strings.cljs$core$IFn$_invoke$arity$1(state),p1__14246_SHARP_,p1__14246_SHARP_);
});})(text,state,matches,temp__4655__auto__))
);
});})(text,state,matches,temp__4655__auto__))
,text,matches);
var G__14249 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,cljs.core.cst$kw$frozen_DASH_strings,((function (text,state,matches,temp__4655__auto__){
return (function (p1__14247_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__14247_SHARP_,matches);
});})(text,state,matches,temp__4655__auto__))
);
text = G__14248;
state = G__14249;
...
var vec__14252 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__14255 = (function (){var G__14258 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__14259 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__14258,G__14259) : transformer.call(null,G__14258,G__14259));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14255,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14255,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14252,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14252,(1),null);
var G__14261 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__14262 = cljs.core.PersistentVector.EMPTY;
var G__14263 = cljs.core.rest(tokens);
var G__14264 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,cljs.core.cst$kw$found_DASH_token,false);
out = G__14261;
buf = G__14262;
tokens = G__14263;
cur_state = G__14264;
...
var G__14265 = out;
var G__14266 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__14267 = cljs.core.rest(tokens);
var G__14268 = cur_state;
out = G__14265;
buf = G__14266;
tokens = G__14267;
cur_state = G__14268;
...
var G__14269 = out;
var G__14270 = buf;
var G__14271 = cljs.core.rest(tokens);
var G__14272 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,cljs.core.cst$kw$found_DASH_token,true);
out = G__14269;
buf = G__14270;
tokens = G__14271;
cur_state = G__14272;
...
var G__14273 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__14274 = buf;
var G__14275 = cljs.core.rest(tokens);
var G__14276 = cur_state;
out = G__14273;
buf = G__14274;
tokens = G__14275;
cur_state = G__14276;
...
var fexpr__14277 = markdown.common.make_separator.cljs$core$IFn$_invoke$arity$4(separator,open,close,(cljs.core.truth_(escape_QMARK_)?markdown.common.escape_code_transformer:cljs.core.identity));
return (fexpr__14277.cljs$core$IFn$_invoke$arity$2 ? fexpr__14277.cljs$core$IFn$_invoke$arity$2(text,state) : fexpr__14277.call(null,text,state));
});
...
var fexpr__14278 = markdown.common.make_separator.cljs$core$IFn$_invoke$arity$4(markdown.common._STAR_inhibit_separator_STAR_,"","",markdown.common.freeze_string);
return (fexpr__14278.cljs$core$IFn$_invoke$arity$2 ? fexpr__14278.cljs$core$IFn$_invoke$arity$2(text,state) : fexpr__14278.call(null,text,state));
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [text,state], null);
}
});
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__14279_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__14279_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__14280_SHARP_){
return (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__14280_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__14280_SHARP_));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
