...
var len__9122__auto___14221 = arguments.length;
var i__9123__auto___14222 = (0);
while(true){
if((i__9123__auto___14222 < len__9122__auto___14221)){
args__9129__auto__.push((arguments[i__9123__auto___14222]));

var G__14223 = (i__9123__auto___14222 + (1));
i__9123__auto___14222 = G__14223;
continue;
} else {
}
break;
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq14220){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14220));
});
...
var G__14226 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__4655__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$kw$frozen_DASH_strings.cljs$core$IFn$_invoke$arity$1(state),p1__14224_SHARP_,p1__14224_SHARP_);
});})(text,state,matches,temp__4655__auto__))
);
});})(text,state,matches,temp__4655__auto__))
,text,matches);
var G__14227 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,cljs.core.cst$kw$frozen_DASH_strings,((function (text,state,matches,temp__4655__auto__){
return (function (p1__14225_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__14225_SHARP_,matches);
});})(text,state,matches,temp__4655__auto__))
);
text = G__14226;
state = G__14227;
...
var vec__14230 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__14233 = (function (){var G__14236 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__14237 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__14236,G__14237) : transformer.call(null,G__14236,G__14237));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14233,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14233,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14230,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14230,(1),null);
var G__14239 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__14240 = cljs.core.PersistentVector.EMPTY;
var G__14241 = cljs.core.rest(tokens);
var G__14242 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,cljs.core.cst$kw$found_DASH_token,false);
out = G__14239;
buf = G__14240;
tokens = G__14241;
cur_state = G__14242;
...
var G__14243 = out;
var G__14244 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__14245 = cljs.core.rest(tokens);
var G__14246 = cur_state;
out = G__14243;
buf = G__14244;
tokens = G__14245;
cur_state = G__14246;
...
var G__14247 = out;
var G__14248 = buf;
var G__14249 = cljs.core.rest(tokens);
var G__14250 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,cljs.core.cst$kw$found_DASH_token,true);
out = G__14247;
buf = G__14248;
tokens = G__14249;
cur_state = G__14250;
...
var G__14251 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__14252 = buf;
var G__14253 = cljs.core.rest(tokens);
var G__14254 = cur_state;
out = G__14251;
buf = G__14252;
tokens = G__14253;
cur_state = G__14254;
...
var fexpr__14255 = markdown.common.make_separator.cljs$core$IFn$_invoke$arity$4(separator,open,close,(cljs.core.truth_(escape_QMARK_)?markdown.common.escape_code_transformer:cljs.core.identity));
return (fexpr__14255.cljs$core$IFn$_invoke$arity$2 ? fexpr__14255.cljs$core$IFn$_invoke$arity$2(text,state) : fexpr__14255.call(null,text,state));
});
...
var fexpr__14256 = markdown.common.make_separator.cljs$core$IFn$_invoke$arity$4(markdown.common._STAR_inhibit_separator_STAR_,"","",markdown.common.freeze_string);
return (fexpr__14256.cljs$core$IFn$_invoke$arity$2 ? fexpr__14256.cljs$core$IFn$_invoke$arity$2(text,state) : fexpr__14256.call(null,text,state));
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [text,state], null);
}
});
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__14257_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__14257_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__14258_SHARP_){
return (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__14258_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__14258_SHARP_));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
