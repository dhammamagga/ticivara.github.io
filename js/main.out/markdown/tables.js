...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15477_SHARP_){
return cljs.core.identity(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$text,p1__15477_SHARP_], null));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.string.trim,(function (){var G__15479 = clojure.string.trim((function (){var fexpr__15480 = (function (p1__15475_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__15475_SHARP_),"|")){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.rest(p1__15475_SHARP_));
} else {
return p1__15475_SHARP_;
}
});
return fexpr__15480(text);
})());
var fexpr__15478 = ((function (G__15479){
return (function (p1__15476_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__15476_SHARP_,/\|/);
});})(G__15479))
;
return fexpr__15478(G__15479);
})()));
});
