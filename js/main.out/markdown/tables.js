...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14371_SHARP_){
return cljs.core.identity(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$text,p1__14371_SHARP_], null));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.string.trim,(function (){var G__14373 = clojure.string.trim((function (){var fexpr__14374 = (function (p1__14369_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__14369_SHARP_),"|")){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.rest(p1__14369_SHARP_));
} else {
return p1__14369_SHARP_;
}
});
return fexpr__14374(text);
})());
var fexpr__14372 = ((function (G__14373){
return (function (p1__14370_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__14370_SHARP_,/\|/);
});})(G__14373))
;
return fexpr__14372(G__14373);
})()));
});
...
var alignment_str = (cljs.core.truth_(cljs.core.cst$kw$alignment.cljs$core$IFn$_invoke$arity$1(col))?[" align='",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(cljs.core.cst$kw$alignment.cljs$core$IFn$_invoke$arity$1(col))),"'"].join(''):null);
if(cljs.core.truth_(is_header_QMARK_)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),"<th",cljs.core.str.cljs$core$IFn$_invoke$arity$1(alignment_str),">",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$text.cljs$core$IFn$_invoke$arity$1(col)),"</th>"].join('');
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),"<td",cljs.core.str.cljs$core$IFn$_invoke$arity$1(alignment_str),">",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$text.cljs$core$IFn$_invoke$arity$1(col)),"</td>"].join('');
}
}),"",row_data);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(table_acc),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((is_header_QMARK_)?"<thead>":((is_first_row_QMARK_)?"<tbody>":null))),"<tr>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(markdown.tables.table_row__GT_str(row_data,is_header_QMARK_)),"</tr>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((is_header_QMARK_)?"</thead>":((is_last_row_QMARK_)?"</tbody>":null)))].join('');
...
var is_table_divider_QMARK_ = (function (){var and__7941__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(table_divider_re,text);
if(and__7941__auto__){
var and__7941__auto____$1 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$table,cljs.core.cst$kw$in_DASH_table_DASH_body_QMARK_], null));
