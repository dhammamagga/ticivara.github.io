...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8578__auto__,writer__8579__auto__,opt__8580__auto__){
return cljs.core._write(writer__8579__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13965 = o;
(G__13965[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__7941__auto__ = !((jsprops == null));
if(and__7941__auto__){
var and__7941__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__13971 = jsprops;
(G__13971["defaultValue"] = value);

(G__13971["onChange"] = ((function (G__13971,v,value,on_change){
return (function (p1__13970_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13970_SHARP_);
});})(G__13971,v,value,on_change))
);
...
var vec__13974 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13974,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13974,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13974,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13978 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13978 == null)){
} else {
var key_13979 = temp__4661__auto___13978;
...
var G__13980 = reagent.impl.template.__GT_NativeWrapper();
(G__13980["name"] = c);
...
var G__13981 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13981) : reagent.impl.template.as_element.call(null,G__13981));
} else {
...
var len__9122__auto___13986 = arguments.length;
var i__9123__auto___13987 = (0);
while(true){
if((i__9123__auto___13987 < len__9122__auto___13986)){
args__9129__auto__.push((arguments[i__9123__auto___13987]));

var G__13988 = (i__9123__auto___13987 + (1));
i__9123__auto___13987 = G__13988;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9130__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13984){
var G__13985 = cljs.core.first(seq13984);
var seq13984__$1 = cljs.core.next(seq13984);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13985,seq13984__$1);
});
...
break;
default:
var G__13991 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13991;
continue;
...
var n__8898__auto___13993 = a.length;
var i_13994 = (0);
while(true){
if((i_13994 < n__8898__auto___13993)){
(a[i_13994] = reagent.impl.template.as_element((a[i_13994])));

var G__13995 = (i_13994 + (1));
i_13994 = G__13995;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8898__auto___13996 = a.length;
var i_13997 = (0);
while(true){
if((i_13997 < n__8898__auto___13996)){
var val_13998 = (a[i_13997]);
if((cljs.core.vector_QMARK_(val_13998)) && ((reagent.impl.template.key_from_vec(val_13998) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13997] = reagent.impl.template.as_element(val_13998));

var G__13999 = (i_13997 + (1));
i_13997 = G__13999;
continue;
} else {
}
...
var ctx = ({});
var vec__14000 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14000,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14000,(1),null);
...
var G__14003 = (cljs.core.count(argv) - first_child);
switch (G__14003) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__14003){
