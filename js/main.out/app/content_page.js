...
var text_key_18772 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1([cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$2([cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.session.get(cljs.core.cst$kw$page))].join(''),(1))),"-content"].join(''));
var txt_18773 = app.text.text(text_key_18772);
var html_18774 = markdown.core.md__GT_html.cljs$core$IFn$_invoke$arity$variadic(txt_18773,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$heading_DASH_anchors,true,cljs.core.cst$kw$reference_DASH_links,true,cljs.core.cst$kw$footnotes,true], 0));
var c_18775 = document.getElementById("page");
(c_18775["innerHTML"] = html_18774);
