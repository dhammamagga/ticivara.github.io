...
var val_buffer_width = (function (){var G__16546 = cljs.core.cst$kw$buffer_DASH_width.cljs$core$IFn$_invoke$arity$1(sabong);
return Number(G__16546);
})();
var val_inner_width = (function (){var G__16547 = cljs.core.cst$kw$width.cljs$core$IFn$_invoke$arity$1(sabong);
return Number(G__16547);
})();
var val_inner_height = (function (){var G__16548 = cljs.core.cst$kw$height.cljs$core$IFn$_invoke$arity$1(sabong);
return Number(G__16548);
})();
var val_kusi_width = (function (){var G__16549 = cljs.core.cst$kw$kusi_DASH_width.cljs$core$IFn$_invoke$arity$1(sabong);
return Number(G__16549);
})();
var vec__16540 = app.helpers.calc_sabong_shrinking_lengths(cljs.core.cst$kw$sabong.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(data)));
var val_cut_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16540,(0),null);
var val_cut_height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16540,(1),null);
var val_mandala_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16540,(2),null);
var val_mandala_height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16540,(3),null);
var val_border_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16540,(4),null);
var val_border_height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16540,(5),null);
var text = ((function (sabong,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pos_buffer_width,pos_border_width,pos_kusi_width,pos_mandala_width,pos_mandala_height,pattern_scale,val_buffer_width,val_inner_width,val_inner_height,val_kusi_width,vec__16540,val_cut_width,val_cut_height,val_mandala_width,val_mandala_height,val_border_width,val_border_height){
...
;
var vec__16543 = app.helpers.init_canvas(cljs.core.cst$kw$_SHARP_sabong_DASH_pattern_DASH_canvas,"img/sabong-pattern.svg");
var monet_canvas = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16543,(0),null);
var img = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16543,(1),null);
app.canvas.add_entity(monet_canvas,cljs.core.cst$kw$background,app.canvas.entity(null,null,((function (sabong,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pos_buffer_width,pos_border_width,pos_kusi_width,pos_mandala_width,pos_mandala_height,pattern_scale,val_buffer_width,val_inner_width,val_inner_height,val_kusi_width,vec__16540,val_cut_width,val_cut_height,val_mandala_width,val_mandala_height,val_border_width,val_border_height,text,text_title,text_num,text_mandala_width,text_kusi_width,text_kusi_height,text_mandala_height,text_accumulate_horiz,text_accumulate_vert,vec__16543,monet_canvas,img){
